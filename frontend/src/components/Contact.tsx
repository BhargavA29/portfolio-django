    ...
    return (
        <div className='max-w-[1000px] mx-auto flex flex-col lg:flex-row text-white/70 p-8 rounded-lg space-y-8 lg:space-y-0 lg:space-x-8 ' id='contact'>
            ...
            <div className='flex justify-center items-center'>
                <ul className='space-y-4'>
                    <li className='flex items-center'>
                        <a href='tel:+919136618176' className='flex items-center'>
                            <Image src={phone} alt='phone' className=' h-[50px] w-auto mr-6 md:h-[110px]' />
                            <p className='text-xl'>+91 9136618176</p>
                        </a>
                    </li>
                    <li className='flex items-center'>
                        <a href='mailto:bhargavayare@gmail.com' className='flex items-center'>
                            <Image src={mail} alt='mail' className='h-[50px] w-auto mr-6 md:h-[110px]' />
                            <p className='text-xl'>bhargavayare@gmail.com</p>
                        </a>
                    </li>
            ...
            <div className='bg-white/10 p-6 rounded-xl max-w-[550px]'>
                ...
                <form action={"https://getform.io/f/bvrelejb"} method='POST' className='space-y-4'>
                    ...
                    <textarea name="message" typeof="text" className='w-full bg-black/70 rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-orange-400' placeholder='Your Message' />
